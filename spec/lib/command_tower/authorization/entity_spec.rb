...
RSpec.describe CommandTower::Authorization::Entity do
  let(:method_count) { 5 }
  ...
  describe "#initialize" do
    ...
    context "when only and except passed in" do
      ...
      it do
        expect { subject }.to raise_error(CommandTower::Authorization::Error, /At most 1 can be passed in/)
      end
    end
    ...
    context "when controller is not valid" do
      ...
      it do
        expect { subject }.to raise_error(CommandTower::Authorization::Error, /was not found/)
      end
    end
    ...
    context "when methods do not exist" do
      context "when only" do
        ...
        it do
          expect { subject }.to raise_error(CommandTower::Authorization::Error, /only parameter is invalid/)
        end
      end
      ...
      context "when except" do
        ...
        it do
          expect { subject }.to raise_error(CommandTower::Authorization::Error, /except parameter is invalid/)
        end
      end
    end
