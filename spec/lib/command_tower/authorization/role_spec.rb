...
RSpec.describe CommandTower::Authorization::Role do
  ...
  describe ".create_role" do
    ...
    context "with duplicate role" do
      ...
      it "raises" do
        expect { described_class.create_role(**params) }.to raise_error(CommandTower::Authorization::Error, /Must use different name/)
      end
    end
    ...
    context "when incorrect entities" do
      ...
      it "raises" do
        expect { described_class.create_role(**params) }.to raise_error(CommandTower::Authorization::Error, /Parameter :entities must include objects of or inherited by/)
      end
    end
