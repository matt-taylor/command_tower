...
RSpec.describe CommandTower::Inbox::MessageBlastController, :with_rbac_setup, type: :controller do
  ...
  describe "GET: blast" do
    ...
    context "with invalid ID" do
      ...
      include_examples "CommandTower::Schema::Error:InvalidArguments examples", 400, "MessageBlast ID not found", :id
    end
  ...
  describe "POST: create" do
    ...
    context "with invalid params" do
      ...
      include_examples "CommandTower::Schema::Error:InvalidArguments examples", 400, "Parameter [title] is required but not present", :title
    end
