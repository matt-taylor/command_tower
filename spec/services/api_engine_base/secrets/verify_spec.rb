...
RSpec.describe ApiEngineBase::Secrets::Verify do
  let(:generate) { ApiEngineBase::Secrets::Generate.(**generate_params) }
  ...
  describe ".call" do
    ...
    context "when not valid" do
      ...
      context "when config deletes secret" do
        before { ApiEngineBase.config.delete_secret_after_invalid = false }
