...
RSpec.describe CommandTower::LoginStrategy::PlainText::EmailVerification::Send do
  ...
  describe ".call" do
    ...
    context "with email failure" do
      before do
        allow_any_instance_of(CommandTower::EmailVerificationMailer).to receive(:verify_email).and_raise(StandardError, "This is an Error")
      end
