...
RSpec.describe CommandTower::LoginStrategy::PlainText::EmailVerification::Verify do
  let(:code) { CommandTower::LoginStrategy::PlainText::EmailVerification::Generate.(user:).secret }
