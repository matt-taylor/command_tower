...
RSpec.describe CommandTower::ServiceBase do
  before do
  ...
  describe "composition validations" do
    ...
    shared_examples "composition failure modes" do
      context "when raise" do
        ...
        it do
          expect { subject }.to raise_error(CommandTower::ServiceBase::CompositionValidationError, /Composite Key failure for/)
        end
      end
    ...
    context "with default" do
      ...
      context "with is_a" do
        ...
        context "when fails" do
          ...
          it do
            expect { subject }.to raise_error(CommandTower::ServiceBase::DefaultValueError, /Default value provided/)
          end
        end
      end
  ...
  describe "validations" do
    ...
    context "when duplicate key" do
      it do
        expect { klass.validate(context_values.keys.sample) }.to raise_error(CommandTower::ServiceBase::NameConflictError, /Duplicate key name found/)
      end
    end
